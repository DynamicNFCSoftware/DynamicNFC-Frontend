...
const TR = {
  en: {
    ...
    chall3Title:'Generic Outreach', chall3Desc:'Every buyer gets the same pitch, the same tour, the same call script. A penthouse investor and a first-time family buyer hear the same message.', chall3Short:'Same pitch for every buyer.',

    /* The Shift (Pitch Deck p.3) */
    shiftLabel:'The Shift', shiftTitle:'From Public Website to Private Invitation',
    shiftDesc:'What if you stopped treating your project website as a public listing, and instead treated it as a Private Buyer Experience for selected prospects? Not everyone — only those you intentionally invite.',
    ...
    how2Title:'Premium Box Delivery', how2Desc:'A premium box with a personalized invitation — a Private Invitation, not a marketing piece. Physical touch builds trust.',
    ...
    diffDesc:'Inside the experience, buyers are free to do whatever they want — book a viewing, request pricing, explore payment plans, download materials. There is no forced funnel. The only difference is identity.',
    ...
    faq3A:'A premium box containing a VIP Access Key — a brushed-metal NFC card with a personalized message. Not a marketing piece. A Private Invitation. When they tap, they enter a web experience designed specifically for them. No app required.',
  ...
  ar: {
    ...
    chall3Title:"تواصل عام", chall3Desc:"كل مشترٍ يحصل على نفس العرض، ونفس الجولة، ونفس نص المكالمة. مستثمر البنتهاوس ومشتري الأسرة لأول مرة يسمعان نفس الرسالة.", chall3Short:"نفس العرض لكل مشترٍ.",

    shiftLabel:"التحول", shiftTitle:"من موقع عام إلى دعوة خاصة",
    shiftDesc:"ماذا لو توقفت عن التعامل مع موقع مشروعك كقائمة عامة، وبدأت التعامل معه كتجربة مشترٍ خاصة لعملاء مختارين؟ ليس للجميع — بل فقط لمن تدعوهم عمدًا.",
    ...
    how2Title:"توصيل الصندوق الفاخر", how2Desc:"صندوق فاخر مع دعوة شخصية — دعوة خاصة، وليست مادة تسويقية. اللمسة المادية تبني الثقة.",
    ...
    diffDesc:"داخل التجربة، يكون المشترون أحرارًا في القيام بما يريدون — حجز زيارة، طلب الأسعار، استكشاف خطط الدفع، تنزيل المواد. لا يوجد مسار إلزامي. الفرق الوحيد هو الهوية.",
    ...
    faq3Q:"ما الذي يتلقاه المشتري فعلياً", faq3A:"صندوق فاخر يحتوي على مفتاح وصول لكبار الشخصيات — بطاقة الاتصال قريب المدى معدنية مصقولة مع رسالة شخصية. ليست مادة تسويقية. بل دعوة خاصة. عندما يلمس البطاقة، يدخل تجربة ويب مصممة خصيصًا له. لا يتطلب تطبيقًا.",
