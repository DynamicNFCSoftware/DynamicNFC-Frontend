...
const TR = {
  en: {
    ...
    roiBtn: 'Model revenue impact',
    roiBtnSub: 'Projections',
    roiFeatsAria: 'What the calculator estimates',
    roiFeat1: 'Viewings',
    roiFeat2: 'Conversion',
    roiFeat3: 'Pipeline',
    ...
    demoRe: 'Real Estate Developers & Agents',
    ...
    ind1t: 'Real Estate Developers & Agents',
    ind1d: 'VIP buyer portals, behavioral analytics, CRM intelligence, agent cards, and lead capture. One platform for launches and listings.',
    ind1cta: 'Real Estate Solutions →',
    ind1tags: ['VIP Portals', 'Behavioral Analytics', 'Agent Cards', 'Lead Capture'],
    ind2t: 'Enterprise NFC Cards',
    ind2d: 'Premium metal, 24K gold, bamboo, PVC cards with custom encoding. Bulk orders, team provisioning, worldwide fulfillment.',
    ind2cta: 'Enterprise Cards →',
    ind2tags: ['Metal & Gold', 'Bulk Orders', 'Team Management', 'Analytics'],
    ind3t: 'Automotive Dealerships',
    ...
    trustAria: 'Company credentials',
    trust1: 'Built in Canada',
    trust2: 'AI-assisted workflows',
    trust3: 'Gulf pilot programs',
  ...
  ar: {
    ...
    roiBtn: 'نمذجة أثر الإيرادات',
    roiBtnSub: 'إسقاطات',
    roiFeatsAria: 'ما تقدره الآلة الحاسبة',
    roiFeat1: 'المعاينات',
    roiFeat2: 'التحويل',
    roiFeat3: 'خط المبيعات',
    ...
    ind1t: "مطورو ووكلاء العقارات", ind1d: "بوابات مشتري VIP، تحليلات سلوكية، ذكاء CRM، بطاقات الوكلاء، والتقاط العملاء. منصة واحدة للإطلاقات والعروض.",
    ind1cta: "حلول العقارات →", ind1tags: ['بوابات VIP', 'تحليلات سلوكية', 'بطاقات الوكلاء', 'التقاط العملاء'],
    ind2t: "بطاقات NFC للمؤسسات", ind2d: "بطاقات معدنية فاخرة، ذهب 24 قيراط، خشب بامبو، وبطاقات PVC مع ترميز مخصص.",
    ...
    trustAria: 'معالم الشركة',
    trust1: 'صُنع في كندا',
    trust2: 'أتمتة وذكاء اصطناعي',
    trust3: 'برامج تجريبية في الخليج',
...
const STEP_ICON_CHART = (
  <svg className="hp-step-svg-fill" viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden>
    <rect x="5" y="14" width="3.5" height="7" rx="1" opacity="0.82" />
    <rect x="10.25" y="10" width="3.5" height="11" rx="1" opacity="0.9" />
    <rect x="15.5" y="6" width="3.5" height="15" rx="1" />
  </svg>
);
...
export default function Home() {
  ...
  const SocialProofSection = () => {
    const trustItems = [
      {
        k: 'trust1',
        icon: (
          <svg className="hp-sp-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      ...
      },
      {
        k: 'trust2',
        icon: (
          <svg className="hp-sp-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" aria-hidden>
      ...
      },
      {
        ...
        icon: (
          <svg className="hp-sp-svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
            ...
            <path d="M12 2a14.8 14.8 0 0 1 0 20M12 2a14.8 14.8 0 0 0 0 20" />
          </svg>
        ),
      },
    ];
    return (
      <div className="hp-social-proof">
        <ul className="hp-social-proof-list" aria-label={t('trustAria')}>
          {trustItems.map(({ k, icon }) => (
            <li key={k} className="hp-social-proof-item">
              <span className="hp-sp-icon">{icon}</span>
              <span className="hp-sp-label">{t(k)}</span>
            </li>
          ))}
        </ul>
      </div>
      ...
      },
      {
        ...
        icon: (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" aria-hidden>
            ...
            <path d="M7 12h4M15 12h2" />
          </svg>
        ),
      },
    ];
    return (
      <section className="re-roi-banner hp-reveal hp-roi-velocity" aria-labelledby="hp-roi-velocity-heading">
        <div className="re-roi-banner-glow hp-roi-velocity-glow" />
        <div className="re-roi-banner-content hp-roi-velocity-card">
          <div className="hp-roi-velocity-visual">
            <div className="re-roi-banner-icon hp-roi-velocity-icon" aria-hidden>
              <svg width="44" height="44" viewBox="0 0 48 48" fill="none">
                <rect x="6" y="26" width="8" height="12" rx="2" fill="#6ba3c7" className="hp-roi-bar hp-roi-bar-1" />
                <rect x="20" y="18" width="8" height="20" rx="2" fill="#457b9d" className="hp-roi-bar hp-roi-bar-2" />
                <rect x="34" y="8" width="8" height="30" rx="2" fill="#e63946" className="hp-roi-bar hp-roi-bar-3" />
              </svg>
            </div>
            <span className="hp-roi-velocity-ring" aria-hidden />
          </div>
          <div className="re-roi-banner-text hp-roi-velocity-copy">
            <span className="re-roi-banner-badge hp-roi-velocity-badge">{t('roiBadge')}</span>
            <h3 id="hp-roi-velocity-heading">{t('roiTitle1')}<em>{t('roiTitle2')}</em>{t('roiTitle3')}</h3>
            <p>{t('roiDesc')}</p>
            <ul className="hp-roi-velocity-pills" aria-label={t('roiFeatsAria')}>
              {roiPills.map(({ k, icon }) => (
                <li key={k} className="hp-roi-velocity-pill">
                  <span className="hp-roi-velocity-pill-icon">{icon}</span>
                  <span>{t(k)}</span>
                </li>
              ))}
            </ul>
          </div>
          <Link to="/sales/roi-calculator" className="re-roi-banner-btn hp-roi-velocity-cta hp-roi-cta-enterprise">
            <span className="hp-roi-cta-text">
              <span className="hp-roi-cta-sub">{t('roiBtnSub')}</span>
              <span className="hp-roi-cta-main">{t('roiBtn')}</span>
            </span>
    ...
    <section className="hp-section hp-section-wide hp-reveal">
      ...
      <div className="hp-steps">
        {[
          ...
          { n: '04', k: 'step4', icon: STEP_ICON_CHART, color: 'accent' },
        ].map((s, i) => (
          <div className={`hp-step hp-step-${s.color}`} key={i}>
            <div className="hp-step-visual">
              <span className="hp-step-bg-num">{s.n}</span>
              <div className="hp-step-orb">
                <span className="hp-step-icon-wrap">{s.icon}</span>
                <div className="hp-step-glow" />
              </div>
            </div>
  ...
  const IndustriesSection = () => (
    <section className="hp-section hp-section-wide hp-reveal hp-section-industries">
      ...
      <div className="hp-ind-grid hp-reveal-stagger">
        {[
          ...
          <div
            className={`hp-ind-card ${ind.c}${ind.wide ? ' hp-ind-wide' : ''}`}
            key={i}
    ...
    <section className="hp-cta-section hp-reveal">
      <div className="hp-cta-inner">
        ...
        <div className="hp-cta-btns">
          ...
          <button onClick={() => navigate('/enterprise/crmdemo')} className="hp-btn ghost-light">{t('tryItYourself')}</button>
        </div>
      </div>
    </section>
  );
