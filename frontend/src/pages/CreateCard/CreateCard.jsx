              ...
              <div className="customize-card_card-edit-section__GI5mw">
                ...
                <div className="OnboardingLayout_navigation-buttons-section__3Cusm">
                  <div
                    ...
                    <div data-reach-tooltip-trigger="" data-state="tooltip-hidden" style={{ display: "flex", gap: 50 }}>
                      <Link
                        aria-disabled="false"
                        ...
                        <div className="Button_button-content__tRj6R">Back</div>
                      ...
                      <button onClick={handleNext}
                        ...
                        type="submit">
                        <div className="Button_button-content__tRj6R">Create my card</div>
                        <div className="Button_loader-container__VRaoC">
                          <div className="Loader_loader__7ZWW3" />
                        </div>
                      </button>
