...
const T = {
  en: {
    ...
    b4: "Analytics Dashboard", c4t: "Unified Dashboard — Dealer Intelligence",
    ...
    c5d: "Watch AI coordinate Canva, Gmail, WhatsApp, Google Calendar, DocuSign, and your CRM — seven actions across six platforms, delivering a complete VIP test drive experience from NFC tap to signed agreement in under 60 seconds.",
    c5tags: ["Canva", "Gmail", "WhatsApp", "Google Calendar", "DocuSign", "CRM Sync", "Live MCP"],
  ...
  ar: {
    ...
    b4: "لوحة تحليلات", c4t: "اللوحة الموحدة — ذكاء التاجر",
    ...
    c5d: "شاهد كيف ينسّق الذكاء الاصطناعي بين Canva وGmail وWhatsApp وتقويم Google وDocuSign ونظام CRM — سبعة إجراءات عبر ست منصات، لتقديم تجربة تجربة قيادة VIP كاملة من نقر NFC إلى الاتفاقية الموقعة في أقل من 60 ثانية.",
    c5tags: ["Canva", "Gmail", "WhatsApp", "تقويم Google", "DocuSign", "مزامنة CRM", "MCP مباشر"],
