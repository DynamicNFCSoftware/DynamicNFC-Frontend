...
const TR = {
  en: {
    ...
    heroDesc: '{name} taps his NFC card. In under a minute: a spec dossier is designed, an email is sent, WhatsApp delivers the invite, a test drive is booked, an NDA is signed, and CRM syncs. Every result below is real — click any link to verify.',
    ...
    triggerDesc: '{name} walks into the showroom and taps his card. We instantly know who he is, what he looked at before, and that he\'s been eyeing the {vehicle} for three days.',
    canvaDesc: 'A 7-page spec dossier gets built on the spot — his name, his vehicle, performance numbers, configuration. Luxury design, bilingual layout. This is a real Canva file — click through and check.',
    gmailDesc: 'The spec dossier gets attached to a personal invite email and lands in {firstName}\'s inbox. This is a real Gmail draft — open it yourself.',
    ...
    calendarDesc: 'The system checks who\'s free, picks the best time, and books a private test drive. A real Google Calendar event you can verify.',
    docusignDesc: 'Before {firstName} arrives, we send him a purchase agreement NDA. He signs, exclusive pricing unlocks in his portal. Pre-filled, ready to go.',
    ...
    docUnlock: 'Workflow triggered: Exclusive VIP pricing unlocked in {firstName}\'s showroom portal',
    openPortal: 'Open {firstName}\'s portal — pricing unlocked →',
    finalH2: 'Done.', finalTotal: 's total.',
    finalDesc: '{name} has a spec dossier in his inbox, a WhatsApp invite, a test drive on his calendar, an NDA waiting for his signature, and a CRM deal at Test Drive Scheduled. Your sales team can focus on closing — not chasing.',
    finalItem1: 'Spec dossier built and exported', finalItem2: 'Email drafted and sent', finalItem3: 'WhatsApp invite delivered',
    finalItem4: 'Test drive booked', finalItem5: 'NDA sent, pricing unlocked', finalItem6: 'CRM synced — Test Drive Scheduled',
    finalScheduled: 'Scheduled — if the NDA is unsigned within 24h of the test drive, a reminder goes out automatically.',
    finalDashCta: 'See it land in your dashboard →',
    emailModalTitle: '{project}', emailModalSub: 'VIP Private Test Drive Invitation',
    emailDear: 'Dear {firstName},',
    emailBody1: 'Thank you for your continued interest in {project}. As a VIP client, we are pleased to invite you to an',
    emailBody1b: 'exclusive private test drive',
    emailBody1c: 'of the {vehicle}.',
    emailBrochure: 'Your personalized vehicle spec dossier is attached. Please complete the enclosed NDA to unlock exclusive VIP pricing before your test drive.',
    emailRegards: 'Warm regards,', emailTeam: '{project} VIP Team', emailPowered: 'Powered by Dynamic NFC',
    emailRealDraft: 'This is a real draft — Open in Gmail',
    emailVehicleDetail: '{color} Exterior &bull; VIP Configuration &bull; Priority Service',
    ...
    stepCanvaTitle: 'Build his spec dossier',
    ...
    stepCalendarTitle: 'Book the test drive',
  ...
  ar: {
    ...
    heroDesc: '{name} ينقر بطاقة NFC. خلال أقل من دقيقة: يتم تصميم ملف مواصفات، إرسال بريد، توصيل الدعوة عبر واتساب، حجز تجربة قيادة، توقيع اتفاقية، ومزامنة CRM. كل نتيجة أدناه حقيقية — انقر على أي رابط للتحقق.',
    ...
    triggerDesc: '{name} يدخل صالة العرض وينقر بطاقته. نعرف فورًا من هو، ما شاهده سابقًا، وأنه يتابع {vehicle} منذ ثلاثة أيام.',
    canvaDesc: 'ملف مواصفات من 7 صفحات يُصمم فورًا — اسمه، مركبته، أرقام الأداء، التكوين. تصميم فاخر، ثنائي اللغة. هذا ملف Canva حقيقي — انقر وتحقق.',
    gmailDesc: 'ملف المواصفات يُرفق ببريد دعوة شخصي ويصل إلى بريد {firstName}. هذه مسودة Gmail حقيقية — افتحها بنفسك.',
    whatsappDesc: 'نفس الدعوة تُدفع عبر واتساب للأعمال — إيصالات التسليم، نقرة واحدة للفتح. بلا خلفية؛ الرابط wa.me حقيقي.',
    calendarDesc: 'النظام يتحقق من الأوقات المتاحة، يختار الأنسب، ويحجز تجربة قيادة خاصة. حدث Google Calendar حقيقي يمكنك التحقق منه.',
    docusignDesc: 'قبل وصول {firstName}، نرسل له اتفاقية شراء سرية. يوقّع، والأسعار الحصرية تُفتح في بوابته. معبأ مسبقًا، جاهز.',
    ...
    docUnlock: 'تم تفعيل سير العمل: تم فتح تسعير VIP الحصري في بوابة {firstName} في صالة العرض',
    openPortal: 'افتح بوابة {firstName} — التسعير مفتوح ←',
    finalH2: 'تم.', finalTotal: ' ثانية إجمالي.',
    finalDesc: '{name} لديه ملف مواصفات في بريده، دعوة واتساب، تجربة قيادة في تقويمه، واتفاقية سرية بانتظار توقيعه، وصفقة CRM في مرحلة تجربة القيادة. فريق مبيعاتك يمكنه التركيز على الإغلاق — لا الملاحقة.',
    finalItem1: 'تم بناء ملف المواصفات وتصديره', finalItem2: 'تم صياغة البريد وإرساله', finalItem3: 'تم توصيل دعوة واتساب',
    finalItem4: 'تم حجز تجربة القيادة', finalItem5: 'تم إرسال الاتفاقية، والتسعير مفتوح', finalItem6: 'تمت مزامنة CRM — تجربة قيادة مجدولة',
    finalScheduled: 'مجدول — إذا لم تُوقَّع الاتفاقية خلال 24 ساعة من تجربة القيادة، يُرسل تذكير تلقائيًا.',
    finalDashCta: 'شاهدها تصل إلى لوحتك ←',
    emailModalTitle: '{project}', emailModalSub: 'دعوة تجربة قيادة خاصة لكبار الشخصيات',
    emailDear: 'عزيزي {firstName}،',
    emailBody1: 'شكرًا لاهتمامك المستمر بـ {project}. بصفتك عميل VIP، يسعدنا دعوتك إلى',
    emailBody1b: 'تجربة قيادة خاصة حصرية',
    emailBody1c: 'لـ {vehicle}.',
    emailBrochure: 'ملف مواصفات المركبة المخصص مرفق. يرجى إكمال الاتفاقية المرفقة لفتح تسعير VIP الحصري قبل تجربة القيادة.',
    emailRegards: 'مع أطيب التحيات،', emailTeam: 'فريق VIP لـ {project}', emailPowered: 'مدعوم من Dynamic NFC',
    emailRealDraft: 'هذه مسودة حقيقية — افتح في Gmail',
    emailVehicleDetail: 'خارجية {color} &bull; تكوين VIP &bull; خدمة أولوية',
    ...
    stepCanvaTitle: 'بناء ملف مواصفاته',
    ...
    stepCalendarTitle: 'حجز تجربة القيادة',
...
function buildTerminalLines(vip, recipientEmail) {
  ...
  return {
    trigger: [
      ...
      { type: 'data', text: `Interest: ${vip.vehicleCode}, ${vip.dealership} | Range: ${vip.rangeFmt}` },
      { type: 'data', text: 'Last engagement: 3 days ago (configured trim & color)' },
      { type: 'ok', text: 'VIP profile loaded — triggering AI sales pipeline' },
    ],
    canva: [
      { type: 'cmd', text: "mcp.canva.generate_design({type: 'spec_dossier', style: 'luxury_automotive'})" },
      { type: 'wait', text: 'AI generating personalized VIP spec dossier...' },
    ...
    gmail: [
      ...
      { type: 'data', text: `Subject: '${vip.firstName}, your private test drive of the ${vip.vehicleName} is confirmed'` },
      { type: 'data', text: `Attaching: ${vip.attachment} (3.1MB)` },
      { type: 'data', text: 'Content: Personal invitation + Canva spec dossier attached' },
      { type: 'ok', text: `Email drafted successfully — recipient: ${to}` },
    ],
    whatsapp: [
      { type: 'cmd', text: 'mcp.whatsapp.business.send({template: "vip_invite"})' },
      { type: 'wait', text: 'Pushing spec dossier link via WhatsApp Business...' },
    ...
    calendar: [
      ...
      { type: 'cmd', text: "mcp.gcal.create_event({summary: 'Private Test Drive...'})" },
      { type: 'ok', text: `Event created: 'Private Test Drive — ${vip.vehicleName}'` },
    ...
    docusign: [
      ...
      { type: 'data', text: `Document: VIP Purchase Agreement NDA — ${vip.dealership} (4 sections)` },
    ...
    crm: [
      ...
      { type: 'cmd', text: "crm.deals.update({stage: 'test_drive'})" },
      { type: 'ok', text: `Deal stage → Test Drive Scheduled | Value: ${vip.priceFmt}` },
    ],
  };
}
...
function buildDemoResults(vip) {
  ...
  return {
    canva: {
      ...
      title: `Private Test Drive Invitation — ${vip.name}`,
      pages: 7,
      ...
      exportFormat: 'PDF',
      sections: ['Cover', 'Personal Letter', 'The Vehicle', 'Performance & Specs', 'Your Configuration', 'Your Invitation', 'Back Cover'],
    },
    calendar: {
      title: `Private Test Drive — ${vip.vehicleName} — ${vip.name} (VIP)`,
      date: day,
      time: `10:00 AM – 11:00 AM ${vip.timeLabel.split(' ').pop()}`,
    ...
    gmail: {
      to: vip.email,
      subject: `${vip.firstName}, your private test drive of the ${vip.vehicleName} is confirmed`,
    ...
    docusign: {
      template: `VIP Purchase Agreement NDA — ${vip.dealership}`,
      recipient: vip.name,
      email: vip.email,
      envelopeId: null,
      status: 'created',
...
export default function AutoAIDemo() {
  ...
  const vip = useMemo(() => getAutoAiVip(regionId, lang), [regionId, lang]);
  const vipFill = useMemo(() => ({
    name: vip.name,
    firstName: vip.firstName,
    vehicle: vip.vehicleName,
    code: vip.vehicleCode,
    project: vip.dealership,
    price: vip.priceFmt,
    range: vip.rangeFmt,
    city: vip.city,
    email: vip.email,
  ...
  const fireTrack = useCallback((key) => {
    ...
    if (key === 'trigger') trackPortalEvent('vip', persona, 'portal_opened', { source: 'auto_ai_demo', portal: 'ai_pipeline' });
    if (key === 'canva') trackPortalEvent('vip', persona, 'download_brochure', { source: 'auto_ai_demo', step: 'dossier', vehicleName: vip.vehicleName });
    if (key === 'gmail') trackPortalEvent('vip', persona, 'contact_advisor', { source: 'auto_ai_demo', channel: 'email' });
    if (key === 'whatsapp') trackPortalEvent('vip', persona, 'contact_advisor', { source: 'auto_ai_demo', channel: 'whatsapp' });
    if (key === 'calendar') trackPortalEvent('vip', persona, 'book_viewing', { source: 'auto_ai_demo', unitName: vip.vehicleName });
    if (key === 'docusign') trackPortalEvent('vip', persona, 'request_pricing', { source: 'auto_ai_demo', step: 'nda' });
  }, [vip]);
  ...
  const crmPayload = {
    ...
    score: 87,
    events: 6,
    deal: { stage: 'test_drive', value: vip.priceFmt },
  };
  ...
  return (
    <div className={`ai-demo ${theme}`} dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      <SEO title="Automotive AI Sales Demo" description="Interactive AI-orchestrated automotive sales pipeline automation demo." path="/automotive/demo/ai" />
      ...
      <header className="ai-hd">
        <Link to="/automotive/demo" className="ai-hd-logo"><img src="/assets/images/logo.png" alt="DynamicNFC" /></Link>
        ...
        <div className="ai-hd-right">
          ...
          <Link to="/automotive/demo" className="ai-home-btn">
                        ...
                        {cfg.key === 'trigger' && (
                          <div className="ai-profile">
                            ...
                            <div className="ai-profile-info">
                              ...
                              <p>{vip.tier} Tier &bull; Interest: {vip.vehicleName} &bull; Range: {vip.rangeFmt}<br/>Last configured {vip.vehicleName} &bull; 3 days ago &bull; VIP ID: {vip.vipId}</p>
                            </div>
                        ...
                        {cfg.key === 'canva' && (
                          <div className="ai-canva-card">
                            ...
                            <div className="ai-canva-preview">
                              <img className="ai-canva-thumb" src={results.canva.thumbnailUrl} alt="Spec dossier cover" onError={(e) => { e.target.style.display = 'none'; }} />
                        ...
                        {cfg.key === 'docusign' && (() => {
                          ...
                          return (
                            <div className="ai-doc-card">
                              ...
                              <Link to="/automotive/demo/khalid?vip_pricing=unlocked" className="ai-portal-cta">
                                {tf('openPortal')}
                              </Link>
                            </div>
                          );
              ...
              <div className="ai-em-body">
                ...
                <div className="ai-em-content">
                  ...
                  <div className="ai-em-unit-card">
                    <h5>{vip.vehicleName} — {vip.priceFmt}</h5>
                    <p dangerouslySetInnerHTML={{ __html: tf('emailVehicleDetail') }} />
                  </div>
