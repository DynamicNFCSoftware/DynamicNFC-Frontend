...
const LANG = {
  en: {
    ...
    leadForm: {
      ...
      namePh: "e.g. Alex Martin", emailPh: "your@email.com", phonePh: "+1 XXX XXX XXXX",
  ...
  ar: {
    ...
    leadForm: {
      ...
      namePh: "مثال: أليكس مارتن", emailPh: "بريدك@مثال.com", phonePh: "+١ XXX XXX XXXX",
      submit: "سجّل واستمر",
  ...
  es: {
    ...
    leadForm: {
      ...
      namePh: "ej. Alex Martin", emailPh: "tu@email.com", phonePh: "+XX XXX XXX XXXX",
  ...
  fr: {
    ...
    leadForm: {
      ...
      namePh: "ex. Alex Martin", emailPh: "votre@email.com", phonePh: "+1 XXX XXX XXXX",
