...
export default function CardAdmin() {
  ...
  const handleCreateCard = async () => {
    ...
    try {
      ...
      toast.success(`Card ${form.cardId} created`);
      closeModal();
      await fetchData();
    } catch (e) {
  ...
  const handleEditCard = async () => {
    ...
    try {
      ...
      toast.success(`Card ${editId} updated`);
      closeModal();
      await fetchData();
    } catch (e) {
      setFormError(e.message);
  ...
  const handleDeactivate = async () => {
    ...
    try {
      ...
      toast.success(`Card ${deactivateId} deactivated`);
      closeModal();
      await fetchData();
    } catch (e) {
  ...
  const handleCreateCampaign = async () => {
    ...
    try {
      ...
      toast.success(`Campaign "${campForm.name}" created`);
      closeModal();
      await fetchData();
    } catch (e) {
      setFormError(e.message);
  ...
  return (
    <div className="ca-page">
      <SEO title="Card Management" description="Manage NFC smart cards, assign users, track campaigns, and monitor performance." path="/admin/cards" />
      <AdminNav />
