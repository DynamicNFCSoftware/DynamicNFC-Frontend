...
const TR = {
  en: {
    ...
    chall3Icon:'📋', chall3Title:'Generic Outreach', chall3Desc:'Every buyer gets the same email, the same call script, the same pitch. A penthouse investor and a first-time family buyer hear the same message.', chall3Short:'Same pitch for every buyer.',

    /* The Shift (Pitch Deck p.3) */
    shiftLabel:'The Shift', shiftTitle:'From Public Website to Private Invitation',
    shiftDesc:'What if you stopped treating your website as a public listing, and instead treated it as a Private Buyer Experience for selected prospects? Not everyone — only those you intentionally invite.',
  ...
  ar: {
    ...
    chall3Icon:"📋", chall3Title:"تواصل عام", chall3Desc:"كل مشتري يتلقى نفس البريد الإلكتروني، نفس نص المكالمة، ونفس العرض. المستثمر في البنتهاوس والعائلة لأول مرة يسمعون نفس الرسالة.", chall3Short:"نفس العرض لكل مشترٍ.",
    shiftLabel:"التحول", shiftTitle:"من موقع عام إلى دعوة خاصة",
    shiftDesc:"ماذا لو توقفت عن التعامل مع موقعك كقائمة عامة — وبدأت معاملة الموقع كتجربة مشترٍ خاصة لمختارين فقط؟ ليس للجميع — فقط لأولئك الذين تدعوهم عمدًا.",
    ...
    how2Title:"تسليم الصندوق الفاخر", how2Desc:"صندوق فاخر مع دعوة شخصية — دعوة خاصة، وليست مادة تسويقية. اللمسة المادية تبني الثقة.",
