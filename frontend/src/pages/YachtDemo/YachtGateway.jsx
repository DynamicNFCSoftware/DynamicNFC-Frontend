...
const T = {
  en: {
    ...
    c3d: "Watch AI coordinate a complete VIP sea-trial experience — specification, invitation, calendar, and agreement — from NFC tap to signature.",
  ...
  ar: {
    ...
    c3d: "شاهد الذكاء الاصطناعي ينسّق تجربة إبحار VIP كاملة — مواصفات، دعوة، تقويم، واتفاقية — من نقرة NFC إلى التوقيع.",
  ...
  es: {
    ...
    c3d: "Vea a la IA coordinar una experiencia completa de prueba de mar VIP — ficha, invitación, calendario y acuerdo — del toque NFC a la firma.",
    c3tags: ["Canva", "Gmail", "Google Calendar", "DocuSign"],
  ...
  fr: {
    ...
    c3d: "Regardez l'IA coordonner une expérience complète d'essai en mer VIP — specification, invitation, calendrier et accord — du tap NFC à la signature.",
    c3tags: ["Canva", "Gmail", "Google Calendar", "DocuSign"],
