...
const T = {
  en: {
    ...
    tagline: "DynamicNFC Yacht Brokerage Technology Demo",
    ...
    c3d: "Watch AI coordinate a complete VIP sea-trial experience — specification, invitation, WhatsApp push, calendar, agreement, and CRM sync — seven actions across six platforms, from NFC tap to signature.",
    c3tags: ["Canva", "Gmail", "WhatsApp", "Google Calendar", "DocuSign", "CRM Sync"],
  ...
  ar: {
    ...
    c3d: "شاهد الذكاء الاصطناعي ينسّق تجربة إبحار VIP كاملة — مواصفات، دعوة، إرسال واتساب، تقويم، اتفاقية، ومزامنة CRM — سبعة إجراءات عبر ست منصات، من نقرة NFC إلى التوقيع.",
    c3tags: ["Canva", "Gmail", "WhatsApp", "تقويم Google", "DocuSign", "مزامنة CRM"],
    ...
    footer: "بيئة العرض التجريبي لـ", footerLink: "DynamicNFC",
    footerEnd: "عرض تقنية وساطة اليخوت. لا يوجد تتبع على هذه الصفحة.",
    homeBtn: "الرئيسية",
  },
  es: {
    badge: "Entorno de Demo en Vivo",
    tagline: "Demo de Tecnología de Corretaje de Yates de DynamicNFC",
    ...
    c3d: "Vea a la IA coordinar una experiencia completa de prueba de mar VIP — ficha, invitación, envío por WhatsApp, calendario, acuerdo y sincronización con su CRM — siete acciones en seis plataformas, del toque NFC a la firma.",
    c3tags: ["Canva", "Gmail", "WhatsApp", "Google Calendar", "DocuSign", "Sincronización CRM"],
    ...
    howTitle: "Cómo Funciona DynamicNFC",
  ...
  fr: {
    ...
    c3d: "Regardez l'IA coordonner une expérience complète d'essai en mer VIP — spécification, invitation, envoi WhatsApp, calendrier, accord et synchronisation CRM — sept actions sur six plateformes, du tap NFC à la signature.",
    c3tags: ["Canva", "Gmail", "WhatsApp", "Google Calendar", "DocuSign", "Synchronisation CRM"],
    ...
    howTitle: "Comment Fonctionne DynamicNFC",
    ...
    footer: "Environnement de démo pour", footerLink: "DynamicNFC",
