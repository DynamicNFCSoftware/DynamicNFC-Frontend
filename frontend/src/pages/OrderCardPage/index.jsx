...
export default function OrderCardPage() {
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'}>
      <SEO title="Order NFC Cards" description="Order custom NFC business cards with digital profiles or physical PVC, metal, and eco-friendly options." path="/order-card" />
