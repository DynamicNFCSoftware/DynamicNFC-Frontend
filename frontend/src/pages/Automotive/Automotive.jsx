...
const TR = {
  en: {
    /* SEO */
    seoTitle:'Automotive — Sales Velocity Engine',
    seoDesc:'Turn showroom visits into signed deals with VIP Access Keys, private portals, and real-time intent signals for automotive dealers.',

    /* Section nav */
    navChallenge:'The Blind Spot', navHow:'How It Works', navUseCases:'Use Cases', navDemo:'Live Demo', navImpact:'Impact', navPilot:'Request a Pilot',
    ...
    probQuote:'Your highest-intent buyers spend weeks researching models, configurations, and financing options online. Yet when they walk into the showroom, your sales team starts from zero — no history, no preferences, no ', probQuoteHighlight:'context.',
    prob1Title:'Anonymous Showroom Traffic', prob1Desc:'Walk-ins browse models, take brochures, and leave. No identity, no follow-up, no conversion tracking.',
    prob2Title:'Delayed Follow-ups', prob2Desc:'Sales teams reach out days later with generic offers — no insight into which models, trims, or financing the buyer explored.',
    prob3Title:'One-Size-Fits-All Pitch', prob3Desc:'Every buyer gets the same presentation — whether they want a family SUV or a performance coupe.',
    ...
    uc1Title:'Luxury & Performance', uc1Desc:'Create exclusive digital experiences for high-net-worth buyers exploring limited editions, bespoke configurations, and premium services.',
    uc1Tag1:'Bespoke Config', uc1Tag2:'VIP Concierge', uc1Tag3:'Private Viewings',
    uc2Title:'Fleet & Corporate', uc2Desc:'Streamline fleet purchasing with dedicated portals showing volume pricing, model comparisons, and lease vs. buy calculators.',
    uc2Tag1:'Volume Pricing', uc2Tag2:'Fleet Management', uc2Tag3:'Corporate Accounts',
    uc3Title:'Certified Pre-Owned', uc3Desc:'Give CPO buyers confidence with vehicle history, inspection reports, warranty details, and personalized recommendations.',
    uc3Tag1:'Vehicle History', uc3Tag2:'Inspection Reports', uc3Tag3:'Warranty Info',
    uc4Title:'EV & New Energy', uc4Desc:'Educate and convert EV-curious buyers with range calculators, charging maps, incentive breakdowns, and test-drive scheduling.',
    ...
    trust2Title:'NFC + QR Fallback', trust2Desc:'NFC for instant access. QR code backup for universal compatibility. No app downloads.',
    trust3Title:'DMS Integration', trust3Desc:'Sits on top of your existing dealer management system. Enhances your DMS with behavioral intelligence.',
    trust4Title:'Adaptive Personalization', trust4Desc:'Content and follow-up cues adapt to each buyer\'s preferences, financing stage, and engagement history.',

    /* ROI banner strip (same key family as common) */
    roiBannerBadge:'Sales velocity tool',
    roiBannerTitleBefore:'How much revenue would ',
    roiBannerTitleEm:'75',
    roiBannerTitleAfter:' VIP invitations generate?',
    roiBannerSub:'Plug in your dealership numbers — see the projected impact on test drives, conversion, and sales pipeline in real time.',
    roiBannerCta:'Calculate your ROI',
    ...
    faq4A:'A premium VIP Access Key — an NFC-enabled card with a personal message. Not a marketing piece — a Private Invitation to their digital showroom.',
  ...
  ar: {
    ...
    seoDesc:'حوّل زيارات صالة العرض إلى صفقات موقعة عبر مفاتيح VIP وبوابات خاصة وإشارات نية لحظية لوكلاء السيارات.',

    navChallenge:'النقطة العمياء', navHow:'كيف تعمل', navUseCases:'حالات الاستخدام', navDemo:'عرض تجريبي مباشر', navImpact:'التأثير', navPilot:'طلب تجربة تجريبية',
    ...
    probQuote:'يقضي المشترون الأكثر جدية أسابيع في البحث عن الموديلات والتكوينات وخيارات التمويل عبر الإنترنت. ومع ذلك، عندما يدخلون صالة العرض، يبدأ فريق المبيعات من الصفر — بدون تاريخ، بدون تفضيلات، بدون ', probQuoteHighlight:'سياق.',
    prob1Title:'حركة مرور مجهولة في صالة العرض', prob1Desc:'يتصفح الزوار الموديلات، يأخذون كتيبات، ويغادرون. بدون هوية، بدون متابعة، بدون تتبع تحويل.',
    prob2Title:'متابعات متأخرة', prob2Desc:'يتواصل فريق المبيعات بعد أيام بعروض عامة — بدون معرفة الموديلات أو الفئات أو التمويل الذي استكشفه المشتري.',
    prob3Title:'عرض واحد يناسب الجميع', prob3Desc:'كل مشترٍ يحصل على نفس العرض — سواء كان يريد SUV عائلي أو كوبيه رياضي.',
    ...
    uc1Title:'الفخامة والأداء', uc1Desc:'أنشئ تجارب رقمية حصرية للمشترين ذوي الثروات العالية الذين يستكشفون الإصدارات المحدودة والتكوينات المخصصة والخدمات المتميزة.',
    uc1Tag1:'تكوين مخصص', uc1Tag2:'خدمة VIP', uc1Tag3:'عروض خاصة',
    uc2Title:'الأساطيل والشركات', uc2Desc:'تبسيط شراء الأساطيل ببوابات مخصصة تعرض أسعار الجملة ومقارنات الموديلات وحاسبات التأجير مقابل الشراء.',
    uc2Tag1:'أسعار الجملة', uc2Tag2:'إدارة الأساطيل', uc2Tag3:'حسابات الشركات',
    uc3Title:'السيارات المستعملة المعتمدة', uc3Desc:'امنح مشتري السيارات المستعملة الثقة بتاريخ المركبة وتقارير الفحص وتفاصيل الضمان والتوصيات المخصصة.',
    uc3Tag1:'تاريخ المركبة', uc3Tag2:'تقارير الفحص', uc3Tag3:'معلومات الضمان',
    uc4Title:'السيارات الكهربائية والطاقة الجديدة', uc4Desc:'ثقّف وحوّل المشترين المهتمين بالسيارات الكهربائية بحاسبات المدى وخرائط الشحن وتفاصيل الحوافز وجدولة تجارب القيادة.',
    ...
    trust2Title:'NFC + QR احتياطي', trust2Desc:'NFC للوصول الفوري. رمز QR احتياطي للتوافق الشامل. لا حاجة لتنزيل تطبيق.',
    trust3Title:'تكامل نظام إدارة الوكالة', trust3Desc:'يعمل فوق نظام إدارة الوكالة الحالي. يعزز النظام بالذكاء السلوكي.',
    trust4Title:'تخصيص تكيفي', trust4Desc:'يتكيف المحتوى وإشارات المتابعة مع تفضيلات كل مشتري ومرحلة التمويل وتاريخ التفاعل.',

    roiBannerBadge:'أداة تسريع المبيعات',
    roiBannerTitleBefore:'كم من الإيرادات ستولّد ',
    roiBannerTitleEm:'75',
    roiBannerTitleAfter:' دعوات لكبار الشخصيات؟',
    roiBannerSub:'أدخل أرقام وكالتك — شاهد الأثر المتوقع على تجارب القيادة والتحويل وخط المبيعات في الوقت الفعلي.',
    roiBannerCta:'احسب عائد الاستثمار',
    ...
    faq4A:'مفتاح وصول VIP فاخر — بطاقة مزودة بتقنية NFC مع رسالة شخصية. ليست مادة تسويقية — بل دعوة خاصة لصالة العرض الرقمية.',
...
export default function Automotive() {
  ...
  const AUTO_SECTION_NAV = [
    { id: 'problem', labelKey: 'navChallenge' },
    { id: 'how', labelKey: 'navHow' },
    { id: 'usecases', labelKey: 'navUseCases' },
    { id: 'demo-portals', labelKey: 'navDemo' },
    { id: 'roi', labelKey: 'navImpact' },
    { id: 'pilot', labelKey: 'navPilot' },
  ];

  function AutoSvg({ children, size = 24, className = '' }) {
    return (
  ...
  const AUTO_PROB_ICONS = [
    <AutoSvg key="p1"><path d="M5 16l-1.5 1.5" /><path d="M18.5 5.5L17 7" /><path d="M12 7v10" /><path d="M8 17h8" /><path d="M6 7h12" /><path d="M7 7l1.5-3h7L17 7" /></AutoSvg>,
    <AutoSvg key="p2"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></AutoSvg>,
    <AutoSvg key="p3"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" ry="1" /></AutoSvg>,
  ];

  const AUTO_UC_ICONS = [
    <AutoSvg key="uc1"><path d="M3 12h3l3-7h6l3 7h3" /><path d="M5 12v6" /><path d="M19 12v6" /><path d="M7 18h10" /></AutoSvg>,
    <AutoSvg key="uc2"><path d="M20 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 20 16z" /><path d="M7 12h10" /></AutoSvg>,
    <AutoSvg key="uc3"><path d="M14.7 6.3a4 4 0 0 0-5.4 5.4l5.4-5.4z" /><path d="M7 17l2-2" /><path d="M16 8l2-2" /><path d="M3 21l6-6" /></AutoSvg>,
    <AutoSvg key="uc4"><path d="M13 2L3 14h7l-1 8 10-12h-7l1-8z" /></AutoSvg>,
  ];

  const AUTO_TRUST_ICONS = [
    <AutoSvg key="t1"><rect x="4" y="11" width="16" height="11" rx="2" /><path d="M8 11V7a4 4 0 0 1 8 0v4" /></AutoSvg>,
    <AutoSvg key="t2"><rect x="7" y="2" width="10" height="20" rx="2" /><path d="M11 18h2" /></AutoSvg>,
    <AutoSvg key="t3"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></AutoSvg>,
    <AutoSvg key="t4"><path d="M12 2v8" /><path d="M12 14v8" /><path d="M4.93 4.93l5.66 5.66" /><path d="M13.41 13.41l5.66 5.66" /><path d="M19.07 4.93l-5.66 5.66" /><path d="M10.59 13.41l-5.66 5.66" /></AutoSvg>,
  ];
  ...
  return (
    <div className="auto-page" dir={isRTL ? 'rtl' : 'ltr'}>
      <SEO title={t('seoTitle')} description={t('seoDesc')} path="/automotive" />
      ...
      <section className="auto-section auto-problem auto-reveal auto-scroll-target" id="problem">
        <div className="auto-section-label red">{t('probLabel')}</div>
        <div className="auto-section-title">{t('probTitle')}</div>
        <p className="auto-problem-quote">{t('probQuote')}<strong style={{color:'var(--red)'}}>{t('probQuoteHighlight')}</strong></p>
        <div className="auto-problem-cards">
          {[1, 2, 3].map(i => (
            <div className="auto-problem-card" key={i}>
              <div className="auto-problem-card-icon auto-icon-svg">{AUTO_PROB_ICONS[i - 1]}</div>
      ...
      <section className="auto-roi-banner auto-reveal">
        <div className="auto-roi-banner-content">
          ...
          <div className="auto-roi-banner-text">
            <span className="auto-roi-banner-badge">{t('roiBannerBadge')}</span>
      ...
      <section className="auto-section auto-reveal" id="usecases">
        ...
        <div className="auto-uc-accordion">
          {[1, 2, 3, 4].map((i) => {
            const expanded = openUc === i;
            const tags = [1, 2, 3].map((j) => t(`uc${i}Tag${j}`));
            const visibleTags = tags.slice(0, 2);
            const extraCount = Math.max(0, tags.length - visibleTags.length);
            return (
              <div className={`auto-uc-item${expanded ? ' open' : ''}`} key={i}>
                <button
                  type="button"
                  id={`auto-uc-q-${i}`}
                  className="auto-uc-header"
                  onClick={() => setOpenUc(expanded ? null : i)}
                  aria-expanded={expanded}
                  aria-controls={`auto-uc-a-${i}`}
                >
                  <span className="auto-uc-icon" aria-hidden>{AUTO_UC_ICONS[i - 1]}</span>
                  <span className="auto-uc-main">
                    <h4 className="auto-uc-title">{t(`uc${i}Title`)}</h4>
                    <span className="auto-uc-tags" aria-hidden>
                      {visibleTags.map((label, idx) => <span className="auto-uc-tag" key={idx}>{label}</span>)}
                      {extraCount > 0 && <span className="auto-uc-tag auto-uc-tag-more">{`+${extraCount}`}</span>}
                    </span>
                  </span>
                  <span className="auto-uc-action" aria-hidden>
                    <span className="auto-uc-action-icon">{expanded ? '−' : '+'}</span>
                  </span>
                </button>
                <div
                  id={`auto-uc-a-${i}`}
                  role="region"
                  aria-labelledby={`auto-uc-q-${i}`}
                  className="auto-uc-body"
                  hidden={!expanded}
                >
                  <p>{t(`uc${i}Desc`)}</p>
                  <div className="auto-uc-tags auto-uc-tags-full">
                    {tags.map((label, idx) => <span className="auto-uc-tag" key={idx}>{label}</span>)}
                  </div>
                </div>
              </div>
            );
      ...
      {/* ═══ ROI / IMPACT ═══ */}
      <section className="auto-section auto-roi auto-reveal auto-scroll-target" id="roi">
      ...
      <section className="auto-section auto-reveal">
        ...
        <div className="auto-trust-grid">
          {[1, 2, 3, 4].map((i) => {
            const colors = ['red', 'blue', 'teal', 'gold'];
            return (
              <div className="auto-trust-item" key={i}>
                <div className={`auto-trust-icon ${colors[i - 1]}`} aria-hidden>{AUTO_TRUST_ICONS[i - 1]}</div>
      ...
      {/* ═══ FAQ ═══ */}
      <section className="auto-section auto-reveal auto-scroll-target" id="faq">
        <div className="auto-section-label blue">{t('faqLabel')}</div>
        <div className="auto-section-title">{t('faqTitle')}</div>
        <div className="auto-faq-list" role="list">
          {[1, 2, 3, 4, 5, 6].map((i) => {
            const expanded = openFaq === i;
            return (
              <div className="auto-faq-item" key={i} role="listitem">
                <button
                  type="button"
                  id={`auto-faq-q-${i}`}
                  className="auto-faq-q-btn"
                  aria-expanded={expanded}
                  aria-controls={`auto-faq-a-${i}`}
                  onClick={() => setOpenFaq(expanded ? null : i)}
                >
                  <span className="auto-faq-q-text">{t(`faq${i}Q`)}</span>
                  <span className="auto-faq-chevron" aria-hidden>{expanded ? '−' : '+'}</span>
                </button>
                <div
                  id={`auto-faq-a-${i}`}
                  role="region"
                  aria-labelledby={`auto-faq-q-${i}`}
                  className="auto-faq-panel"
                  hidden={!expanded}
                >
                  <p>{t(`faq${i}A`)}</p>
                </div>
          ...
          {!pilotSuccess ? (
            <>
              <div className="auto-pilot-header">
                <h3>{t('modalTitle')}</h3>
                <button type="button" className="auto-pilot-close" onClick={closePilot} aria-label={t('closeLabel')}>
