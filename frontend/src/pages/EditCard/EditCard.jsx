...
/* ── Uses the same CSS as CreateCard (imported via style tag already on page from CreateCard) ── */
...
export default function EditCard() {
      ...
      try {
        ...
        if (snap.exists()) {
          ...
          setCard({
            ...
            email: data.email || "", phoneCode: data.phoneCode || "+971", phoneNum: data.phoneNum || "",
            officePhoneCode: data.officePhoneCode || "+971", officePhoneNum: data.officePhoneNum || "",
  ...
  }, [card, validate, notify, user, hashId]);
