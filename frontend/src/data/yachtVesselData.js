...
function y(id, name, type, marina, price, charterWeekly, guests, cabins, desc, features, specFeature) {
  return {
    ...
    price,
    charterWeekly,
    specs: { guests, cabins, feature: specFeature },
    desc,
    features,
    image: IMG[id] || null,
  };
...
// ─── GULF — SAR ─────────────────────────────────────────────────────
const GULF = [
  y("YA-GULF-001", "Azimut Grande 35 Metri", "motor", "Dubai Marina", 38000000, 320000, 12, 6,
    { en: "A commanding trideck presence berthed at Dubai Marina, the Grande 35 Metri pairs Italian design language with effortless entertaining — made for evenings when the skyline itself joins the guest list.", ar: "حضور مهيب بثلاثة طوابق في مرسى دبي، تجمع غراندي ٣٥ متري بين لغة التصميم الإيطالي وفن الضيافة الراقية — صُممت لأمسيات تكون فيها أضواء المدينة جزءاً من قائمة الضيوف.", es: "Una imponente presencia de tres cubiertas atracada en Dubai Marina: la Grande 35 Metri une el lenguaje del diseño italiano con un arte de recibir sin esfuerzo, pensada para veladas donde el propio horizonte forma parte de la lista de invitados.", fr: "Une présence majestueuse à trois ponts amarrée à Dubai Marina : la Grande 35 Metri allie le langage du design italien à un art de recevoir sans effort — conçue pour des soirées où la skyline elle-même figure sur la liste des invités." },
    [
    ...
    { en: "28 knots", ar: "٢٨ عقدة", es: "28 nudos", fr: "28 nœuds" }),
  y("YA-GULF-002", "Princess X95", "motor", "Jumeirah Bay Marina", 42500000, 285000, 10, 5,
    { en: "The X95 rewrites the flybridge rulebook at Jumeirah Bay — a super-flybridge spanning nearly the full length of the yacht turns every crossing of the Arabian Gulf into a private rooftop event.", ar: "تعيد X95 كتابة قواعد اليخوت في خليج جميرا — سطح علوي فائق يمتد على كامل طول اليخت تقريباً يحوّل كل رحلة عبر الخليج العربي إلى مناسبة خاصة تحت السماء المفتوحة.", es: "El X95 reescribe las reglas del flybridge en Jumeirah Bay: una supercubierta que recorre casi toda la eslora convierte cada travesía del Golfo Arábigo en un evento privado a cielo abierto.", fr: "Le X95 réécrit les règles du flybridge à Jumeirah Bay : un super-flybridge courant sur presque toute la longueur du yacht transforme chaque traversée du golfe Arabique en réception privée à ciel ouvert." },
    [
    ...
    { en: "26 knots", ar: "٢٦ عقدة", es: "26 nudos", fr: "26 nœuds" }),
  y("YA-GULF-003", "Sunseeker 88", "motor", "Mina Rashid", 26000000, 185000, 8, 4,
    { en: "Berthed at Mina Rashid and built for the weekend escape, the Sunseeker 88 delivers 29-knot pace to the Palm and back — British craftsmanship tuned for Gulf waters.", ar: "راسية في ميناء راشد ومصممة لرحلات نهاية الأسبوع، تقدم صنسيكر ٨٨ سرعة ٢٩ عقدة إلى النخلة والعودة — حرفية بريطانية صُقلت لمياه الخليج.", es: "Atracado en Mina Rashid y creado para la escapada de fin de semana, el Sunseeker 88 alcanza 29 nudos hasta la Palmera y de vuelta: artesanía británica afinada para las aguas del Golfo.", fr: "Amarré à Mina Rashid et taillé pour l'escapade du week-end, le Sunseeker 88 file à 29 nœuds jusqu'à la Palm et retour — un savoir-faire britannique accordé aux eaux du Golfe." },
    [
    ...
    { en: "29 knots", ar: "٢٩ عقدة", es: "29 nudos", fr: "29 nœuds" }),
  y("YA-GULF-004", "Benetti Oasis 40M", "motor", "Dubai Marina", 48000000, 380000, 12, 6,
    { en: "The Oasis 40M brings the beach to Dubai Marina: an aft infinity pool framed by fold-down wings dissolves the line between yacht and sea, while a dedicated wellness deck restores before the next reception.", ar: "تجلب أوازيس ٤٠ متراً الشاطئ إلى مرسى دبي: مسبح لا متناهٍ في المؤخرة تحيط به أجنحة قابلة للفتح يمحو الحدود بين اليخت والبحر، بينما يمنح طابق العافية المخصص استرخاءً تاماً قبل الاستقبال التالي.", es: "El Oasis 40M lleva la playa a Dubai Marina: una piscina infinita a popa enmarcada por alas abatibles disuelve la frontera entre yate y mar, mientras una cubierta de bienestar dedicada restaura antes de la próxima recepción.", fr: "L'Oasis 40M amène la plage jusqu'à Dubai Marina : une piscine à débordement à l'arrière, encadrée d'ailes rabattables, efface la frontière entre le yacht et la mer, tandis qu'un pont bien-être dédié ressource avant la prochaine réception." },
    [
    ...
    { en: "Wellness Deck", ar: "طابق العافية", es: "Cubierta de bienestar", fr: "Pont bien-être" }),
  y("YA-GULF-005", "Pershing 9X", "sport", "Mina Rashid", 22500000, 160000, 8, 3,
    { en: "Carbon-built and unapologetically fast, the Pershing 9X turns the run from Mina Rashid to the World Islands into minutes — 42 knots of Italian adrenaline with a couture interior waiting below.", ar: "مصنوعة من ألياف الكربون وسريعة بلا منازع، تحوّل بيرشينغ 9X الرحلة من ميناء راشد إلى جزر العالم إلى دقائق — ٤٢ عقدة من الأدرينالين الإيطالي مع مقصورة داخلية فاخرة في الأسفل.", es: "Construido en carbono y descaradamente veloz, el Pershing 9X convierte el trayecto de Mina Rashid a las World Islands en minutos: 42 nudos de adrenalina italiana con un interior de alta costura esperando abajo.", fr: "Construit en carbone et résolument rapide, le Pershing 9X réduit le trajet de Mina Rashid aux World Islands à quelques minutes — 42 nœuds d'adrénaline italienne avec un intérieur haute couture en contrebas." },
    [
    ...
    { en: "42 knots", ar: "٤٢ عقدة", es: "42 nudos", fr: "42 nœuds" }),
  y("YA-GULF-006", "Ferretti 1000", "motor", "Dubai Marina", 32000000, 225000, 10, 5,
    { en: "Ferretti's flagship at Dubai Marina reads like a waterfront penthouse — an aft beach lounge on the water, a flybridge made for hosting, and five staterooms that keep the whole party aboard.", ar: "السفينة الرائدة من فيريتي في مرسى دبي أشبه بجناح فاخر على الواجهة البحرية — صالة شاطئية خلفية عند مستوى الماء، وسطح علوي مصمم للضيافة، وخمس كبائن تستوعب جميع الضيوف على المتن.", es: "El buque insignia de Ferretti en Dubai Marina se vive como un ático frente al mar: un beach lounge a popa al nivel del agua, un flybridge hecho para recibir y cinco camarotes que mantienen a toda la fiesta a bordo.", fr: "Le navire amiral de Ferretti à Dubai Marina se vit comme un penthouse sur l'eau : un beach lounge arrière au ras des flots, un flybridge fait pour recevoir et cinq cabines qui gardent tous les invités à bord." },
    [
    ...
    { en: "26 knots", ar: "٢٦ عقدة", es: "26 nudos", fr: "26 nœuds" }),
  y("YA-GULF-007", "Sanlorenzo SL90 Asymmetric", "motor", "Mina Rashid", 28500000, 195000, 8, 4,
    { en: "The SL90 Asymmetric keeps its walkway to one side only — a quietly radical move that gifts the salon an extra measure of sea-facing space, berthed at Mina Rashid for owners who collect ideas, not just yachts.", ar: "تحتفظ SL90 أسيمتريك بممر جانبي واحد فقط — خطوة جريئة بهدوء تمنح الصالون مساحة إضافية مطلة على البحر، راسية في ميناء راشد لملاك يقتنون الأفكار لا اليخوت فحسب.", es: "El SL90 Asymmetric conserva el pasillo lateral en un solo costado: un gesto discretamente radical que regala al salón un espacio extra frente al mar, atracado en Mina Rashid para armadores que coleccionan ideas, no solo yates.", fr: "Le SL90 Asymmetric ne conserve sa coursive que d'un seul côté — un geste discrètement radical qui offre au salon un volume supplémentaire face à la mer, amarré à Mina Rashid pour des propriétaires qui collectionnent les idées, pas seulement les yachts." },
    [
    ...
    { en: "Design-awarded", ar: "حائزة على جوائز التصميم", es: "Premiada por su diseño", fr: "Primée pour son design" }),
  y("YA-GULF-008", "Lurssen 85M Custom", "superyacht", "Dubai Marina", 285000000, 1800000, 16, 8,
    { en: "A one-off Lürssen of 85 metres commanding Dubai Marina — helipad, eight staterooms and German engineering built to a single owner's brief. This is not a listing; it is an introduction.", ar: "لورسن فريدة من نوعها بطول ٨٥ متراً تتصدر مرسى دبي — مهبط للطائرات المروحية وثماني كبائن وهندسة ألمانية بُنيت وفق رؤية مالك واحد. هذا ليس عرضاً للبيع، بل دعوة للتعارف.", es: "Un Lürssen único de 85 metros que preside Dubai Marina: helipuerto, ocho camarotes e ingeniería alemana construida según el encargo de un solo armador. Esto no es un anuncio; es una presentación.", fr: "Un Lürssen unique de 85 mètres qui domine Dubai Marina — hélipont, huit cabines et une ingénierie allemande construite selon le cahier des charges d'un seul propriétaire. Ceci n'est pas une annonce ; c'est une introduction." },
    [
    ...
    { en: "Custom", ar: "تصميم خاص", es: "Personalizado", fr: "Sur mesure" }),
];

// ─── USA — USD ──────────────────────────────────────────────────────
const USA = [
  y("YA-USA-001", "Westport 40M", "motor", "San Diego Marina", 18500000, 145000, 12, 6,
    { en: "America's proven 130-footer, berthed in San Diego and ready to work. Series-built consistency means known costs, known systems, and a tri-deck that hosts twelve guests without drama.", ar: "اليخت الأمريكي المجرّب بطول ١٣٠ قدماً، راسٍ في سان دييغو وجاهز للانطلاق. الإنتاج المتسلسل يعني تكاليف معروفة وأنظمة موثوقة وثلاثة طوابق تستضيف اثني عشر ضيفاً بكل سلاسة.", es: "El 130 pies americano de eficacia probada, atracado en San Diego y listo para navegar. Su construcción en serie significa costes conocidos, sistemas conocidos y tres cubiertas que reciben a doce invitados sin complicaciones.", fr: "Le 130 pieds américain qui a fait ses preuves, amarré à San Diego et prêt à naviguer. Sa construction en série garantit des coûts connus, des systèmes connus et trois ponts qui accueillent douze invités sans effort." },
    [
    ...
    { en: "22 knots", ar: "٢٢ عقدة", es: "22 nudos", fr: "22 nœuds" }),
  y("YA-USA-002", "Viking 80 Convertible", "sportfish", "Point Loma", 6800000, 65000, 6, 4,
    { en: "Point Loma's tournament weapon. The Viking 80 gets six anglers to the tuna grounds at 42 knots, fishes hard all day, and brings everyone home to four real cabins — not bunks.", ar: "سلاح البطولات في بوينت لوما. تنقل فايكينغ ٨٠ ستة صيادين إلى مناطق التونة بسرعة ٤٢ عقدة، وتصطاد بجدّ طوال اليوم، وتعيد الجميع إلى أربع كبائن حقيقية — لا مجرد أسرّة.", es: "El arma de torneo de Point Loma. El Viking 80 lleva a seis pescadores a las zonas de atún a 42 nudos, pesca duro todo el día y devuelve a todos a cuatro camarotes de verdad, no literas.", fr: "L'arme de tournoi de Point Loma. Le Viking 80 emmène six pêcheurs sur les zones à thon à 42 nœuds, pêche dur toute la journée et ramène tout le monde vers quatre vraies cabines — pas des couchettes." },
    [
    ...
    { en: "42 knots", ar: "٤٢ عقدة", es: "42 nudos", fr: "42 nœuds" }),
  y("YA-USA-003", "Hatteras M98 Panacera", "motor", "Harbor Island", 12200000, 98000, 10, 5,
    { en: "Hatteras heritage in a modern glass house at Harbor Island — the M98 Panacera pairs American build quality with a light-flooded salon and five staterooms for serious coastal cruising.", ar: "إرث هاتيراس في تصميم زجاجي عصري في هاربر آيلاند — تجمع M98 باناسيرا بين جودة الصناعة الأمريكية وصالون غارق بالضوء وخمس كبائن لإبحار ساحلي رفيع المستوى.", es: "La herencia Hatteras en una casa de cristal moderna en Harbor Island: el M98 Panacera combina la calidad de construcción americana con un salón inundado de luz y cinco camarotes para un crucero costero serio.", fr: "L'héritage Hatteras dans une maison de verre moderne à Harbor Island — le M98 Panacera associe la qualité de construction américaine à un salon baigné de lumière et cinq cabines pour une croisière côtière exigeante." },
    [
    ...
    { en: "24 knots", ar: "٢٤ عقدة", es: "24 nudos", fr: "24 nœuds" }),
  y("YA-USA-004", "Nordhavn 80", "explorer", "San Diego Marina", 9400000, 72000, 8, 4,
    { en: "Built to leave San Diego and simply keep going, the Nordhavn 80 is a true ocean-crossing explorer — full-displacement hull, serious tankage, and the range to make Hawaii a decision, not a dream.", ar: "بُنيت لتغادر سان دييغو وتواصل الإبحار بلا حدود، نوردهافن ٨٠ يخت استكشافي عابر للمحيطات بحق — هيكل إزاحة كاملة وخزانات وقود ضخمة ومدى يجعل الوصول إلى هاواي قراراً لا حلماً.", es: "Construido para salir de San Diego y simplemente seguir adelante, el Nordhavn 80 es un auténtico explorador transoceánico: casco de desplazamiento total, gran capacidad de combustible y la autonomía para hacer de Hawái una decisión, no un sueño.", fr: "Construit pour quitter San Diego et continuer, tout simplement, le Nordhavn 80 est un véritable explorateur transocéanique — coque à déplacement intégral, réservoirs généreux et l'autonomie qui fait d'Hawaï une décision, pas un rêve." },
    [
    ...
    { en: "Ocean-crossing", ar: "عابرة للمحيطات", es: "Transoceánico", fr: "Transocéanique" }),
  y("YA-USA-005", "Bertram 61 Convertible", "sportfish", "Point Loma", 3800000, 42000, 5, 3,
    { en: "The Bertram 61 does one thing without compromise: put five anglers on fish faster than the fleet. Forty-four knots out of Point Loma, a cockpit built for battle, and a name that needs no introduction on the docks.", ar: "تفعل بيرترام ٦١ شيئاً واحداً دون مساومة: إيصال خمسة صيادين إلى الأسماك قبل بقية الأسطول. ٤٤ عقدة انطلاقاً من بوينت لوما، ومنصة صيد مجهزة للمعركة، واسم لا يحتاج إلى تعريف على الأرصفة.", es: "El Bertram 61 hace una sola cosa sin concesiones: poner a cinco pescadores sobre los peces más rápido que la flota. Cuarenta y cuatro nudos desde Point Loma, una bañera hecha para la batalla y un nombre que no necesita presentación en los muelles.", fr: "Le Bertram 61 fait une seule chose, sans compromis : amener cinq pêcheurs sur le poisson plus vite que le reste de la flotte. Quarante-quatre nœuds au départ de Point Loma, un cockpit taillé pour le combat et un nom qui n'a plus à se présenter sur les quais." },
    [
    ...
    { en: "44 knots", ar: "٤٤ عقدة", es: "44 nudos", fr: "44 nœuds" }),
  y("YA-USA-006", "Ocean Alexander 90R", "motor", "Harbor Island", 8900000, 68000, 8, 4,
    { en: "The 90R at Harbor Island is engineered around sightlines — a raised pilothouse frees the main deck for living, and side-opening terraces bring the Pacific to the salon floor.", ar: "صُممت 90R في هاربر آيلاند حول خطوط الرؤية — قمرة قيادة مرتفعة تحرر الطابق الرئيسي للمعيشة، وشرفات جانبية قابلة للفتح تجلب المحيط الهادئ إلى أرضية الصالون.", es: "El 90R de Harbor Island está diseñado en torno a las líneas de visión: un puente elevado libera la cubierta principal para vivir, y las terrazas laterales abatibles acercan el Pacífico al suelo del salón.", fr: "Le 90R de Harbor Island est conçu autour des perspectives : une timonerie surélevée libère le pont principal pour la vie à bord, et des terrasses latérales ouvrantes amènent le Pacifique jusqu'au salon." },
    [
    ...
    { en: "Raised Pilothouse", ar: "قمرة قيادة مرتفعة", es: "Puente elevado", fr: "Timonerie surélevée" }),
  y("YA-USA-007", "Grady-White Canyon 456", "sportfish", "Point Loma", 1250000, 0, 6, 0,
    { en: "The biggest center console Grady-White builds, and it shows: quad Yamaha power off the transom, serious offshore fishing hardware, and enough comfort to make the run back from the banks feel short.", ar: "أكبر قارب بمقصورة قيادة مركزية تصنعه غرادي-وايت، ويظهر ذلك بوضوح: أربعة محركات Yamaha على المؤخرة، وتجهيزات صيد احترافية لعرض البحر، وراحة تجعل رحلة العودة من مناطق الصيد تبدو قصيرة.", es: "El center console más grande que construye Grady-White, y se nota: cuatro motores Yamaha en el espejo de popa, equipamiento serio de pesca de altura y el confort suficiente para que el regreso desde los bancos se haga corto.", fr: "Le plus grand center console jamais construit par Grady-White, et cela se voit : quatre moteurs Yamaha au tableau arrière, un équipement de pêche hauturière sérieux et assez de confort pour que le retour des bancs paraisse court." },
    [
    ...
    { en: "Quad Yamaha 600s", ar: "أربعة محركات Yamaha 600", es: "Cuatro Yamaha 600", fr: "Quatre Yamaha 600" }),
  y("YA-USA-008", "Feadship 80M Custom", "superyacht", "San Diego Marina", 195000000, 1400000, 14, 7,
    { en: "A Dutch flagship of 80 metres lying in San Diego — Feadship's custom pedigree expressed in steel and glass, with seven staterooms and the engineering depth to cross any ocean her owner names.", ar: "سفينة هولندية رائدة بطول ٨٠ متراً راسية في سان دييغو — إرث فيدشيب المخصص متجسداً في الفولاذ والزجاج، مع سبع كبائن وعمق هندسي يمكّنها من عبور أي محيط يختاره مالكها.", es: "Un buque insignia holandés de 80 metros fondeado en San Diego: el pedigrí custom de Feadship expresado en acero y cristal, con siete camarotes y la profundidad de ingeniería para cruzar cualquier océano que su armador elija.", fr: "Un navire amiral néerlandais de 80 mètres mouillé à San Diego — le pedigree sur mesure de Feadship exprimé dans l'acier et le verre, avec sept cabines et la profondeur d'ingénierie pour traverser tout océan que son propriétaire désignera." },
    [
    ...
    { en: "Dutch flagship", ar: "السفينة الهولندية الرائدة", es: "Buque insignia holandés", fr: "Navire amiral néerlandais" }),
];

// ─── MEXICO — MXN ───────────────────────────────────────────────────
const MEXICO = [
  y("YA-MEX-001", "Ferretti Custom Line 130", "motor", "Cabo Marina", 340000000, 2800000, 12, 6,
    { en: "A 40-metre Italian flagship made for grand entertaining between Cabo San Lucas and the Sea of Cortez. Six staterooms and sweeping open decks host family and friends in effortless resort style.", ar: "سفينة إيطالية رائدة بطول ٤٠ متراً صُممت للضيافة الفاخرة بين كابو سان لوكاس وبحر كورتيس. ست أجنحة وأسطح مفتوحة واسعة تستقبل العائلة والأصدقاء بأسلوب منتجعي راقٍ.", es: "Un buque insignia italiano de 40 metros pensado para recibir en grande entre Cabo San Lucas y el Mar de Cortés. Seis camarotes y cubiertas abiertas de gran amplitud reúnen a familia y amigos con el estilo relajado de un resort.", fr: "Un navire amiral italien de 40 mètres conçu pour recevoir en grand entre Cabo San Lucas et la mer de Cortés. Six cabines et de vastes ponts ouverts accueillent famille et amis dans un style de villégiature sans effort." },
    [
    ...
    { en: "22 knots", ar: "٢٢ عقدة", es: "22 nudos", fr: "22 nœuds" }),
  y("YA-MEX-002", "Azimut Magellano 66", "motor", "Puerto Cancun", 65000000, 520000, 8, 4,
    { en: "A long-range navetta that turns the run from Puerto Cancún to Isla Mujeres and Holbox into a weekend ritual. Dual-mode hull comfort with warm Italian interiors built for family cruising.", ar: "يخت نافيتا بعيد المدى يحوّل الرحلة من بويرتو كانكون إلى إيسلا موخيريس وهولبوكس إلى طقس أسبوعي. بدن مزدوج النمط يوفر راحة استثنائية مع تصميم داخلي إيطالي دافئ للرحلات العائلية.", es: "Una navetta de gran autonomía que convierte la travesía de Puerto Cancún a Isla Mujeres y Holbox en un ritual de fin de semana. Casco de doble modo con interiores italianos cálidos, hecha para navegar en familia.", fr: "Une navetta long rayon d'action qui transforme la traversée de Puerto Cancún vers Isla Mujeres et Holbox en rituel de fin de semaine. Confort de carène bimode et intérieurs italiens chaleureux pensés pour la croisière en famille." },
    [
    ...
    { en: "Long-range", ar: "مدى طويل", es: "Gran autonomía", fr: "Long rayon d'action" }),
  y("YA-MEX-003", "Sunseeker Predator 74", "sport", "Puerto Vallarta", 78000000, 640000, 6, 3,
    { en: "Pure adrenaline out of Puerto Vallarta — 38 knots across Banderas Bay with the hardtop open and the beach clubs of Punta Mita within easy reach. A sport yacht that entertains as fiercely as it performs.", ar: "أدرينالين خالص انطلاقاً من بويرتو فايارتا — ٣٨ عقدة عبر خليج بانديراس مع سقف قابل للفتح وشواطئ بونتا ميتا على مرمى البصر. يخت رياضي يضاهي أداءه في الضيافة قوته في الانطلاق.", es: "Pura adrenalina desde Puerto Vallarta: 38 nudos por la Bahía de Banderas con el techo rígido abierto y los beach clubs de Punta Mita a un paso. Un yate deportivo que recibe con la misma intensidad con la que navega.", fr: "Pure adrénaline au départ de Puerto Vallarta — 38 nœuds sur la baie de Banderas, toit rigide ouvert, avec les clubs de plage de Punta Mita à portée de main. Un yacht sport qui reçoit aussi intensément qu'il performe." },
    [
    ...
    { en: "38 knots", ar: "٣٨ عقدة", es: "38 nudos", fr: "38 nœuds" }),
  y("YA-MEX-004", "Princess Y85", "motor", "Puerto Cancun", 92000000, 720000, 8, 4,
    { en: "British craftsmanship tuned for the Mexican Caribbean, with a flybridge made for long lunches over the turquoise of Puerto Cancún. Four ensuite cabins welcome three generations aboard in quiet luxury.", ar: "حرفية بريطانية صُقلت لأجواء الكاريبي المكسيكي، مع سطح فلاي بريدج مثالي لوجبات غداء طويلة فوق فيروز بويرتو كانكون. أربع كبائن بحمامات خاصة تستقبل ثلاثة أجيال على متن فخامة هادئة.", es: "Artesanía británica afinada para el Caribe mexicano, con un flybridge hecho para sobremesas largas sobre el turquesa de Puerto Cancún. Cuatro camarotes con baño propio reciben a tres generaciones a bordo con lujo sereno.", fr: "Un savoir-faire britannique accordé aux Caraïbes mexicaines, avec un flybridge fait pour les longs repas au-dessus du turquoise de Puerto Cancún. Quatre cabines avec salle de bain privée accueillent trois générations dans un luxe discret." },
    [
    ...
    { en: "Flybridge", ar: "فلاي بريدج", es: "Flybridge", fr: "Flybridge" }),
  y("YA-MEX-005", "Boston Whaler 420 Outrage", "sportfish", "Cabo Marina", 18500000, 145000, 8, 0,
    { en: "The serious angler's ticket to Cabo's legendary marlin grounds, built unsinkable and rigged to run. Quad Mercury 450s put the Gordo Banks within reach before the sun clears the Arch.", ar: "بوابة الصياد المحترف إلى مواقع المارلين الأسطورية في كابو، ببناء لا يغرق وتجهيز جاهز للانطلاق. أربعة محركات Mercury 450 تضع ضفاف غوردو في المتناول قبل أن تشرق الشمس فوق قوس كابو.", es: "El boleto del pescador serio a los legendarios bancos de marlín de Cabo, construida insumergible y equipada para correr. Cuatro Mercury 450 ponen los Bancos Gordo al alcance antes de que el sol asome sobre el Arco.", fr: "Le sésame du pêcheur sérieux vers les légendaires zones à marlin de Cabo, construite insubmersible et gréée pour la vitesse. Les quatre Mercury 450 mettent les bancs Gordo à portée avant que le soleil ne dépasse l'Arche." },
    [
    ...
    { en: "Quad Mercury 450s", ar: "أربعة محركات Mercury 450", es: "Cuatro Mercury 450", fr: "Quatre Mercury 450" }),
  y("YA-MEX-006", "Azimut S7", "sport", "Puerto Cancun", 42000000, 340000, 6, 3,
    { en: "Carbon-fibre sport elegance for fast escapes from Puerto Cancún to Cozumel's west-coast reefs. Three cabins and a glass-walled saloon keep the Caribbean in view at every turn.", ar: "أناقة رياضية من ألياف الكربون لرحلات سريعة من بويرتو كانكون إلى شعاب الساحل الغربي لكوزوميل. ثلاث كبائن وصالون بجدران زجاجية يُبقيان الكاريبي في الأفق من كل زاوية.", es: "Elegancia deportiva en fibra de carbono para escapadas veloces de Puerto Cancún a los arrecifes de la costa oeste de Cozumel. Tres camarotes y un salón acristalado mantienen el Caribe a la vista en todo momento.", fr: "Élégance sportive en fibre de carbone pour des escapades rapides de Puerto Cancún vers les récifs de la côte ouest de Cozumel. Trois cabines et un salon vitré gardent les Caraïbes en vue à chaque instant." },
    [
    ...
    { en: "34 knots", ar: "٣٤ عقدة", es: "34 nudos", fr: "34 nœuds" }),
  y("YA-MEX-007", "Intrepid 477 Panacea", "sport", "Cabo Marina", 14200000, 115000, 6, 0,
    { en: "Cabo's ultimate day boat — 55 knots of open-water freedom for spontaneous runs to Chileno Bay or a sunset lap past the Arch with friends. Serious offshore capability wrapped in day-club comfort.", ar: "قارب النهار الأمثل في كابو — ٥٥ عقدة من حرية المياه المفتوحة لرحلات عفوية إلى خليج تشيلينو أو جولة غروب أمام القوس مع الأصدقاء. قدرة بحرية جادة في قالب من راحة النوادي النهارية.", es: "La lancha de día definitiva de Cabo: 55 nudos de libertad en mar abierto para escapadas espontáneas a Bahía Chileno o una vuelta al atardecer frente al Arco con amigos. Capacidad offshore seria envuelta en confort de club de playa.", fr: "Le day boat ultime de Cabo — 55 nœuds de liberté en eaux libres pour des virées spontanées vers Chileno Bay ou un tour au coucher du soleil devant l'Arche entre amis. De sérieuses capacités hauturières dans un confort de club de jour." },
    [
    ...
    { en: "55 knots", ar: "٥٥ عقدة", es: "55 nudos", fr: "55 nœuds" }),
  y("YA-MEX-008", "Benetti Oasis 34M", "motor", "Cabo Marina", 180000000, 1200000, 10, 5,
    { en: "The Oasis deck redefines life at anchor off Cabo — an infinity pool and fold-down terraces that put the whole family at the waterline. Five cabins of Benetti craftsmanship for the Baja's golden evenings.", ar: "سطح Oasis يعيد تعريف الحياة أثناء الرسو قبالة كابو — مسبح إنفينيتي وشرفات قابلة للفتح تضع العائلة بأكملها عند مستوى الماء. خمس كبائن من حرفية Benetti لأمسيات باخا الذهبية.", es: "La cubierta Oasis redefine la vida fondeados frente a Cabo: una alberca infinita y terrazas abatibles que ponen a toda la familia al nivel del agua. Cinco camarotes de artesanía Benetti para las tardes doradas de Baja.", fr: "Le pont Oasis redéfinit la vie au mouillage devant Cabo — piscine à débordement et terrasses rabattables qui placent toute la famille au ras de l'eau. Cinq cabines du savoir-faire Benetti pour les soirées dorées de la Basse-Californie." },
    [
    ...
    { en: "Beach Club", ar: "نادٍ شاطئي", es: "Beach Club", fr: "Beach Club" }),
];

// ─── CANADA — CAD ───────────────────────────────────────────────────
const CANADA = [
  y("YA-CAN-001", "Nordhavn 86", "explorer", "Coal Harbour Marina", 11500000, 85000, 8, 5,
    { en: "A true ocean-crossing expedition yacht at home in Coal Harbour and built for everything beyond it — Desolation Sound, Haida Gwaii, Alaska. Five cabins of quiet capability for the long Pacific Northwest season.", ar: "يخت استكشافي حقيقي عابر للمحيطات يتخذ من كول هاربر موطناً وقد بُني لكل ما يتجاوزه — ديسوليشن ساوند وهايدا غواي وألاسكا. خمس كبائن من القدرة الهادئة لموسم طويل في شمال غرب المحيط الهادئ.", es: "Un auténtico yate de expedición transoceánico con base en Coal Harbour y construido para todo lo que hay más allá: Desolation Sound, Haida Gwaii, Alaska. Cinco camarotes de capacidad silenciosa para la larga temporada del Pacífico Noroeste.", fr: "Un véritable yacht d'expédition transocéanique amarré à Coal Harbour et construit pour tout ce qui s'étend au-delà — Desolation Sound, Haida Gwaii, l'Alaska. Cinq cabines d'une capacité discrète pour la longue saison du Pacifique Nord-Ouest." },
    [
    ...
    { en: "Ocean-crossing", ar: "عابر للمحيطات", es: "Transoceánico", fr: "Transocéanique" }),
  y("YA-CAN-002", "Grand Banks 85", "motor", "Royal Vancouver YC", 8500000, 62000, 8, 4,
    { en: "Understated Pacific Northwest elegance from the Royal Vancouver Yacht Club — an efficient 18-knot cruiser that makes Desolation Sound a long weekend, not an expedition. Warm teak interiors built for grey-sky comfort.", ar: "أناقة هادئة بطابع شمال غرب المحيط الهادئ من نادي فانكوفر الملكي لليخوت — يخت كفء بسرعة ١٨ عقدة يجعل ديسوليشن ساوند عطلة نهاية أسبوع طويلة لا رحلة استكشافية. تصميم داخلي دافئ من خشب الساج لراحة تحت السماء الرمادية.", es: "Elegancia sobria del Pacífico Noroeste desde el Royal Vancouver Yacht Club: un crucero eficiente de 18 nudos que convierte Desolation Sound en un fin de semana largo, no en una expedición. Cálidos interiores de teca hechos para el confort bajo cielos grises.", fr: "L'élégance discrète du Pacifique Nord-Ouest depuis le Royal Vancouver Yacht Club — un croiseur efficace de 18 nœuds qui fait de Desolation Sound une longue fin de semaine plutôt qu'une expédition. Des intérieurs chaleureux en teck pensés pour le confort sous les ciels gris." },
    [
    ...
    { en: "18 knots", ar: "١٨ عقدة", es: "18 nudos", fr: "18 nœuds" }),
  y("YA-CAN-003", "Ocean Alexander 90R", "motor", "Granville Marina", 12800000, 92000, 10, 5,
    { en: "A raised-pilothouse flagship berthed at Granville with the volume of a much larger yacht and sightlines made for the North Shore mountains. Five staterooms host ten guests from False Creek to the Gulf Islands.", ar: "سفينة رائدة بقمرة قيادة مرتفعة راسية في غرانفيل، بمساحات تضاهي يختاً أكبر بكثير وإطلالات صُممت لجبال الشاطئ الشمالي. خمسة أجنحة تستقبل عشرة ضيوف من فولس كريك إلى جزر الخليج.", es: "Un buque insignia de timonera elevada atracado en Granville, con el volumen de un yate mucho mayor y vistas hechas para las montañas de North Shore. Cinco camarotes reciben a diez invitados desde False Creek hasta las Gulf Islands.", fr: "Un navire amiral à timonerie surélevée amarré à Granville, offrant le volume d'un yacht bien plus grand et des lignes de vue faites pour les montagnes de la rive nord. Cinq cabines accueillent dix invités de False Creek aux îles Gulf." },
    [
    ...
    { en: "Raised Pilothouse", ar: "قمرة قيادة مرتفعة", es: "Timonera elevada", fr: "Timonerie surélevée" }),
  y("YA-CAN-004", "Nordhavn 68", "explorer", "Coal Harbour Marina", 6200000, 52000, 6, 4,
    { en: "Trans-Pacific range in a couple-friendly package — the yacht that takes you from Coal Harbour to Hawaii, or simply deep into the Broughtons for a month off-grid. Engineering-first cruising with no compromise on warmth.", ar: "مدى عابر للمحيط الهادئ في تصميم مثالي للزوجين — اليخت الذي يأخذك من كول هاربر إلى هاواي، أو ببساطة إلى عمق أرخبيل بروتون لشهر بعيداً عن العالم. إبحار تتصدر فيه الهندسة دون أي تنازل عن الدفء.", es: "Autonomía transpacífica en un formato pensado para parejas: el yate que te lleva de Coal Harbour a Hawái, o simplemente a lo profundo de las Broughtons para un mes fuera de la red. Navegación de ingeniería primero sin sacrificar calidez.", fr: "Une autonomie transpacifique dans un format pensé pour deux — le yacht qui vous mène de Coal Harbour à Hawaï, ou simplement au cœur des Broughtons pour un mois hors réseau. Une croisière où l'ingénierie prime, sans compromis sur la chaleur." },
    [
    ...
    { en: "Trans-Pacific", ar: "عابر للمحيط الهادئ", es: "Transpacífico", fr: "Transpacifique" }),
  y("YA-CAN-005", "Fleming 65", "explorer", "Royal Vancouver YC", 4800000, 42000, 6, 3,
    { en: "The thinking sailor's bluewater trawler, refined over decades for exactly these waters — Inside Passage summers, Gulf Islands weekends, the occasional run north to Ketchikan. Quietly perfect, never showy.", ar: "يخت تراولر بحري للملّاح الحصيف، صُقل عبر عقود لهذه المياه تحديداً — صيف الممر الداخلي وعطلات جزر الخليج ورحلة شمالاً إلى كيتشيكان بين حين وآخر. كمالٌ هادئ بلا تباهٍ.", es: "El trawler de altura del navegante reflexivo, refinado durante décadas para exactamente estas aguas: veranos en el Inside Passage, fines de semana en las Gulf Islands, alguna travesía al norte hasta Ketchikan. Silenciosamente perfecto, nunca ostentoso.", fr: "Le trawler hauturier du navigateur réfléchi, peaufiné pendant des décennies pour exactement ces eaux — les étés dans l'Inside Passage, les fins de semaine aux îles Gulf, l'occasionnelle remontée vers Ketchikan. Discrètement parfait, jamais tape-à-l'œil." },
    [
    ...
    { en: "Bluewater", ar: "مياه عميقة", es: "De altura", fr: "Hauturier" }),
  y("YA-CAN-006", "Princess Y80", "motor", "Coal Harbour Marina", 7800000, 58000, 8, 4,
    { en: "Dark-hulled British luxury against the glass towers of Coal Harbour — 28 knots to Bowen Island after work, four cabins for the weekend beyond. Refined performance that suits Vancouver's understated waterfront style.", ar: "فخامة بريطانية بهيكل داكن أمام أبراج كول هاربر الزجاجية — ٢٨ عقدة إلى جزيرة بوين بعد العمل، وأربع كبائن لعطلة نهاية الأسبوع وما بعدها. أداء راقٍ يليق بأسلوب فانكوفر الهادئ على الواجهة البحرية.", es: "Lujo británico de casco oscuro frente a las torres de cristal de Coal Harbour: 28 nudos hasta Bowen Island al salir del trabajo, cuatro camarotes para el fin de semana y más allá. Rendimiento refinado a la altura del estilo sobrio del waterfront de Vancouver.", fr: "Le luxe britannique à coque sombre devant les tours de verre de Coal Harbour — 28 nœuds vers Bowen Island après le travail, quatre cabines pour la fin de semaine et au-delà. Une performance raffinée à l'image du style discret du littoral de Vancouver." },
    [
    ...
    { en: "28 knots", ar: "٢٨ عقدة", es: "28 nudos", fr: "28 nœuds" }),
  y("YA-CAN-007", "Grady-White Canyon 376", "sportfish", "Granville Marina", 680000, 0, 6, 0,
    { en: "The West Coast angler's workhorse out of Granville — twin Yamaha 425s, a proper offshore hull, and room for six chasing chinook off the Fraser mouth or halibut up the coast. Built for real Pacific weather.", ar: "حصان العمل لصيادي الساحل الغربي انطلاقاً من غرانفيل — محركا Yamaha 425 وبدن بحري حقيقي ومتسع لستة صيادين يطاردون سلمون الشينوك عند مصب نهر فريزر أو الهلبوت على امتداد الساحل. بُني لأجواء المحيط الهادئ الحقيقية.", es: "El caballo de batalla del pescador de la Costa Oeste desde Granville: dos Yamaha 425, un casco offshore de verdad y espacio para seis tras el chinook en la boca del Fraser o el halibut costa arriba. Construida para el clima real del Pacífico.", fr: "Le cheval de trait du pêcheur de la côte Ouest au départ de Granville — deux Yamaha 425, une vraie coque hauturière et de la place pour six à la poursuite du saumon chinook à l'embouchure du Fraser ou du flétan plus haut sur la côte. Construite pour la vraie météo du Pacifique." },
    [
    ...
    { en: "Twin Yamaha 425s", ar: "محركان Yamaha 425", es: "Dos Yamaha 425", fr: "Deux Yamaha 425" }),
  y("YA-CAN-008", "Burger 140 Raised Pilothouse", "superyacht", "Coal Harbour Marina", 58000000, 480000, 12, 6,
    { en: "The North American flagship of the Coal Harbour waterfront — a 140-foot Burger built to host twelve guests from English Bay galas to month-long Inside Passage explorations. Heritage steel craftsmanship, entirely at home in the rain.", ar: "السفينة الرائدة في أمريكا الشمالية على واجهة كول هاربر البحرية — يخت Burger بطول ١٤٠ قدماً بُني لاستضافة ١٢ ضيفاً من حفلات خليج إنجلش إلى استكشافات الممر الداخلي التي تمتد شهراً كاملاً. حرفية فولاذية عريقة تشعر بأنها في موطنها تحت المطر.", es: "El buque insignia norteamericano del waterfront de Coal Harbour: un Burger de 140 pies construido para recibir a doce invitados, desde galas en English Bay hasta exploraciones de un mes por el Inside Passage. Artesanía en acero con herencia, completamente en casa bajo la lluvia.", fr: "Le navire amiral nord-américain du littoral de Coal Harbour — un Burger de 140 pieds construit pour recevoir douze invités, des galas d'English Bay aux explorations d'un mois dans l'Inside Passage. Un savoir-faire patrimonial de l'acier, parfaitement chez lui sous la pluie." },
    [
...
export const VIP_IDS = {
  gulf: ["YA-GULF-008", "YA-GULF-004", "YA-GULF-002", "YA-GULF-001", "YA-GULF-006"],
...
export const TYPE_LABELS = {
  motor: { en: "Motor", ar: "موتور", es: "Motor", fr: "Motor" },
  sport: { en: "Sport", ar: "رياضي", es: "Deportivo", fr: "Sport" },
  explorer: { en: "Explorer", ar: "استكشافي", es: "Explorador", fr: "Explorer" },
  sportfish: { en: "Sportfish", ar: "صيد رياضي", es: "Pesca Deportiva", fr: "Pêche Sportive" },
  superyacht: { en: "Superyacht", ar: "سوبر يخت", es: "Superyate", fr: "Superyacht" },
};
