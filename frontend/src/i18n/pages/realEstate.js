...
const realEstate = {
  en: {
    ...
    seoDesc:
      "Named buyer intent, private portals, and real-time sales signals for brokerages and project sales teams. Book more viewings with DynamicNFC.",
    ...
    challQuote:
      "Your highest-intent buyers spend weeks exploring floor plans, pricing, and payment options online. Yet when your sales team picks up the phone, they often lack one critical thing: ",
    ...
    chall1Short: "You see page views, not people.",
    ...
    chall2Short: "Interest peaks before your team calls.",
    ...
    chall3Short: "Same pitch for every buyer.",
    ...
    how1Desc:
      "Select high-value prospects from your CRM. Each gets a personalized VIP Access Key.",
    how2Title: "Premium Box Delivery",
    how2Desc:
      "A premium box with a personalized invitation — not a flyer. Physical touch builds trust.",
    how3Title: "Tap to Private Portal",
    how3Desc:
      "One tap opens a private portal — floor plans, pricing, booking. No app, no login.",
    how4Title: "Behavioral Intelligence",
    how4Desc:
      "Every portal action feeds your dashboard in real time. Your team knows who is ready.",
    ...
    part1Short: "50–200 VIP prospects from your CRM.",
    ...
    part2Short: "Branded portal matching your project.",
    ...
    part3Short: "Premium boxes with personalized invitations.",
    ...
    part4Short: "Real-time signals, more booked viewings.",
    ...
    roi3Sub: "Your team gets alerts the moment a prospect re-engages",
  ...
  ar: {
    ...
    seoDesc:
      "نية المشترى المعرّفة، بوابات خاصة، وإشارات مبيعات لحظية للوسطاء وفرق مبيعات المشاريع. احجز المزيد من المعاينات مع DynamicNFC.",
    ...
    challQuote:
      "يقضي المشترون الأكثر اهتمامًا أسابيع في استكشاف المخططات والأسعار وخيارات الدفع عبر الإنترنت. ومع ذلك، عندما يتواصل فريق المبيعات، غالبًا ما يفتقرون إلى أمر واحد حاسم: ",
    challQuoteHighlight: "السياق",
    challQuote2:
      ". لا يعرفون من هو مستعد، وما يهتم به أكثر، ومتى يتصرف. هذا يؤدي إلى متابعة متأخرة، محادثات عامة، وفقدان الزخم.",
    ...
    chall1Short: "ترى زيارات، لا أشخاص.",
    ...
    chall2Short: "الاهتمام يبلغ ذروته قبل اتصال فريقك.",
    ...
    chall3Short: "نفس العرض لكل مشترٍ.",
    ...
    how1Desc:
      "اختر عملاء ذوي قيمة عالية من نظامك. كل منهم يحصل على مفتاح وصول باسمه.",
    how2Title: "توصيل العلبة الفاخرة",
    how2Desc:
      "صندوق فاخر مع دعوة شخصية — ليس منشورًا. اللمسة المادية تبني الثقة.",
    how3Title: "لمسة واحدة نحو البوّابة الخاصّة",
    how3Desc:
      "نقرة واحدة تفتح بوابة خاصة — مخططات، أسعار، حجز. بلا تطبيق أو تسجيل.",
    how4Title: "ذكاء سلوكي لحظي",
    how4Desc:
      "كل إجراء يغذي لوحة التحكم لحظيًا. فريقك يعرف من الجاهز.",
    ...
    part1Short: "50–200 عميل VIP من نظامك.",
    ...
    part2Short: "بوابة تحمل هوية مشروعك.",
