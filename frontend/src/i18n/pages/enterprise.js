...
const enterprise = {
  en: {
    ...
    statConversion: "Named Prospects",
    statDecision: "Intent Signals",
    statIdentified: "Zero Guesswork",
    statValNamed: "Named",
    statValIntent: "Real-Time",
    statValZero: "Zero",
    ...
    roiMetric1Label: "Named Intelligence",
    roiMetric1Sub: "Every VIP invitee is identified before the first conversation",
    roiMetric2Label: "Real-Time Intent",
    roiMetric2Sub: "From first tap to booked viewing — with context, not guesswork",
    roiMetric3Label: "Zero Guesswork",
  ...
  ar: {
    ...
    statConversion: "عملاء مُعرَّفون",
    statDecision: "إشارات النية",
    statIdentified: "صفر تخمين",
    statValNamed: "مُعرَّف",
    statValIntent: "لحظي",
    statValZero: "صفر",
    ...
    roiMetric1Label: "ذكاء مُعرَّف بالاسم",
    roiMetric1Sub: "كل مدعو VIP يُعرَّف قبل أول محادثة",
    roiMetric2Label: "نية لحظية",
    roiMetric2Sub: "من أول لمسة إلى المعاينة المحجوزة — بسياق لا بتخمين",
    roiMetric3Label: "صفر تخمين",
