...
<div style="max-width:600px;margin:0 auto;background:#1a1a2e;">
  ...
  <div style="padding:2rem 2.5rem;">
    <p style="color:#e0e0e0;font-size:.95rem;line-height:1.7;">Dear ${buyerName},</p>
    ...
    <div style="background:rgba(184,134,11,0.08);border:1px solid rgba(184,134,11,0.3);border-radius:12px;padding:1.25rem;margin:1.25rem 0;">
      <h3 style="font-family:Georgia,serif;color:#b8860b;margin:0 0 .4rem;font-size:1rem;">${vehicleName} — ${vehiclePrice}</h3>
    ...
    <div style="background:rgba(255,255,255,0.04);border-radius:10px;padding:1rem;margin:1rem 0;">
      ...
      <p style="color:#fff;font-size:1rem;font-weight:600;margin:0;">${testDriveDate} at ${testDriveTime}</p>
      <p style="color:#888;font-size:.82rem;margin:.2rem 0 0;">${testDriveLocation}</p>
