...
export default function SultanPortal() {
  ...
  const openDetail = (v) => {
    ...
    trackEvent("vehicle_view", { vehicleId: v.id, name: v.name, price: v.price });
  };
  ...
  return (
    <div className="sp-page" dir={lang === "ar" ? "rtl" : "ltr"}>
      ...
      <div className="sp-crossnav" style={{ position: "fixed", top: scrolled ? "52px" : "-40px", left: 0, right: 0, zIndex: 99 }}>
        ...
        <a href="/automotive/demo/showroom" target="_blank" rel="noopener noreferrer">Public Showroom</a>
              ...
              {detailTab === "overview" && (
                <>
                  ...
                  <div className="sp-md-acts">
                    ...
                    <button className="sp-btn-g sp-btn-sm" onClick={() => { trackEvent("pricing_request", { vehicleId: selectedVehicle.id }); showToast(t.toast.pricing, "💰"); }}>💰 {t.detail.requestPricing}</button>
                    <button className="sp-btn-o sp-btn-sm" onClick={() => { trackEvent("brochure_download", { vehicleId: selectedVehicle.id }); showToast(t.toast.brochure, "📄"); }}>📄 {t.detail.downloadBrochure}</button>
                ...
                return (
                  <>
                    ...
                    <button className="sp-btn-g" style={{ width: "100%", justifyContent: "center" }} onClick={() => {
                      trackEvent("quote_request", { vehicleId: selectedVehicle.id, mode: finMode, downPct, term: finTerm, monthly: Math.round(monthly) });
