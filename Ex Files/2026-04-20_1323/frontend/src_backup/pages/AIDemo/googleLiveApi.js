...
<div style="max-width:600px;margin:0 auto;background:#ffffff;">
  ...
  <div style="padding:2rem 2.5rem;">
    <p style="color:#333;font-size:.95rem;line-height:1.7;">Dear ${buyerName},</p>
    ...
    <div style="background:rgba(197,164,103,0.08);border:1px solid rgba(197,164,103,0.2);border-radius:12px;padding:1.25rem;margin:1.25rem 0;">
      <h3 style="font-family:Georgia,serif;color:#C5A467;margin:0 0 .4rem;font-size:1rem;">${unitName} — ${unitPrice}</h3>
    ...
    <div style="background:#f8f7f5;border-radius:10px;padding:1rem;margin:1rem 0;">
      ...
      <p style="color:#1a1a2e;font-size:1rem;font-weight:600;margin:0;">${showingDate} at ${showingTime}</p>
      <p style="color:#888;font-size:.82rem;margin:.2rem 0 0;">${showingLocation}</p>
    </div>
